...
use SkyVerge\WooCommerce\PluginFramework\v5_11_6\SV_WC_Payment_Gateway_My_Payment_Methods;
 ...
 *
 * @see \SkyVerge\WooCommerce\PluginFramework\v5_11_6\SV_WC_Payment_Gateway_My_Payment_Methods
 */
class MyPaymentMethodsTest extends \Codeception\TestCase\WPTestCase {
	...
	public function test_render_js() {
		...
		$this->assertStringContainsString( 'window.jQuery( document.body ).on( \'sv_wc_payment_methods_handler_v5_11_6_loaded\', load_gateway_test_plugin_payment_methods_handler );', $wc_queued_js );
	}
