...
use SkyVerge\WooCommerce\PluginFramework\v5_9_0\SV_WC_Payment_Gateway_Payment_Form;

/**
 * Tests for the SV_WC_Payment_Gateway_Payment_Form class.
 *
 * @see \SkyVerge\WooCommerce\PluginFramework\v5_9_0\SV_WC_Payment_Gateway_Payment_Form
 */
class PaymentFormTest extends \Codeception\TestCase\WPTestCase {
	...
	public function test_render_js() {
		...
		$this->assertStringContainsString( 'window.jQuery( document.body ).on( \'sv_wc_payment_form_handler_v5_9_0_loaded\', load_test_gateway_payment_form_handler );', $wc_queued_js );
	}
