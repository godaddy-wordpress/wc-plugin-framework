...
use SkyVerge\WooCommerce\PluginFramework\v5_10_7\SV_WC_Payment_Gateway_Apple_Pay;
use SkyVerge\WooCommerce\PluginFramework\v5_10_7\SV_WC_Payment_Gateway_Apple_Pay_Frontend;

/**
 * Tests for the SV_WC_Payment_Gateway_Apple_Pay_Frontend class.
 *
 * @see \SkyVerge\WooCommerce\PluginFramework\v5_10_7\SV_WC_Payment_Gateway_Apple_Pay_Frontend
 */
class ApplePayFrontendTest extends \Codeception\TestCase\WPTestCase {
	...
	public function test_enqueue_js_handler() {
		...
		$this->assertStringContainsString( 'window.jQuery( document.body ).on( \'sv_wc_apple_pay_handler_v5_10_7_loaded\', load_test_gateway_apple_pay_handler );', $wc_queued_js );
	}
