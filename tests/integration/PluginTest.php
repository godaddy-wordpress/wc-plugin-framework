 ...
 *
 * @see \SkyVerge\WooCommerce\PluginFramework\v5_7_1\SV_WC_Plugin
 */
class PluginTest extends \Codeception\TestCase\WPTestCase {
	...
	public function test_get_dependency_handler() {
		...
		$this->assertInstanceOf( '\SkyVerge\WooCommerce\PluginFramework\v5_7_1\SV_WC_Plugin_Dependencies', $this->get_plugin()->get_dependency_handler() );
	}
	...
	public function test_get_lifecycle_handler() {
		...
		$this->assertInstanceOf( '\SkyVerge\WooCommerce\PluginFramework\v5_7_1\Plugin\Lifecycle', $this->get_plugin()->get_lifecycle_handler() );
	}
