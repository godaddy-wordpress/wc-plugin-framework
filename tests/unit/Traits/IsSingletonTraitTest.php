...
namespace SkyVerge\WooCommerce\PluginFramework\v6_0_1\Tests\Unit\Traits;

use Exception;
use ReflectionClass;
use SkyVerge\WooCommerce\PluginFramework\v6_0_1\Tests\TestCase;
use SkyVerge\WooCommerce\PluginFramework\v6_0_1\Traits\IsSingletonTrait;
...
class IsSingletonTraitTest extends TestCase
{
	 ...
	 *
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Traits\IsSingletonTrait::isLoaded()
	 */
	 ...
	 *
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Traits\IsSingletonTrait::getInstance()
	 */
	 ...
	 *
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Traits\IsSingletonTrait::reset()
	 */
