...
namespace SkyVerge\WooCommerce\PluginFramework\v6_0_2\Tests\Unit\Traits;

use Exception;
use Generator;
use SkyVerge\WooCommerce\PluginFramework\v6_0_2\Tests\TestCase;
use SkyVerge\WooCommerce\PluginFramework\v6_0_2\Traits\CanConvertToArrayTrait;
use stdClass;
...
final class CanConvertToArrayTraitTest extends TestCase
{
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_2\Traits\CanConvertToArrayTrait::toArray()
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_2\Traits\CanConvertToArrayTrait::toArrayShouldPropertyBeAccessible()
	 *
	 ...
	 *
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_2\Traits\CanConvertToArrayTrait::canConvertItemToArray()
	 *
	 * @throws Exception
	 */
