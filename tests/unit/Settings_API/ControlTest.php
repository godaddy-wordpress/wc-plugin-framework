...
namespace SkyVerge\WooCommerce\PluginFramework\v6_2_0\Tests\Unit\Settings_API;

use SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control;
use SkyVerge\WooCommerce\PluginFramework\v6_2_0\SV_WC_Plugin_Exception;
...
{
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::get_setting_id()
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::get_type()
	 * @throws SV_WC_Plugin_Exception
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::get_name()
	 * @throws SV_WC_Plugin_Exception
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::get_description()
	 * @throws SV_WC_Plugin_Exception
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::get_options()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::set_setting_id()
	 *
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::set_type()
	 *
	 * @param mixed $value value to pass to the method
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::set_name()
	 *
	 * @param mixed $value value to pass to the method
	 * @param string $expected expected value
	 * @param bool $exception whether an exception is expected
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::set_description()
	 *
	 * @param mixed $value value to pass to the method
	 * @param string $expected expected value
	 * @param bool $exception whether an exception is expected
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_0\Settings_API\Control::set_options()
	 *
