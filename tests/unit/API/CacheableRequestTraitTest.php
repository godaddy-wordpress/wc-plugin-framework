...
namespace SkyVerge\WooCommerce\PluginFramework\v6_2_3\Tests\Unit\API;

use SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait;
...
class CacheableRequestTraitTest extends TestCase
{
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::get_cache_lifetime()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::set_cache_lifetime()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::should_refresh()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::set_force_refresh()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::set_should_cache()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits\Cacheable_Request_Trait::bypass_cache()
	 */
