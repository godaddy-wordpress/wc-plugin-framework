...
namespace SkyVerge\WooCommerce\PluginFramework\v5_15_12\Tests\Unit;

use Generator;
use Mockery;
use ReflectionException;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Addresses;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Admin\Notes_Helper;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\API\Abstract_Cacheable_API_Base;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Handlers\Country_Helper;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\Blocks as Payment_Gateway_Blocks;
...
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\External_Checkout\Frontend;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\External_Checkout\Google_Pay as Google_Pay_Checkout;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\External_Checkout\Orders;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\Handlers;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\PaymentFormContextChecker;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Plugin\Lifecycle;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\REST_API;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\Settings_API;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Admin_Notice_Handler;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Admin_Payment_Token_Editor;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_API_Authorization_Response;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_API_Get_Tokenized_Payment_Methods_Response;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_API_Response;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Apple_Pay_AJAX;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Exception;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Integration;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Integration_Subscriptions;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Payment_Gateway_Payment_Tokens_Handler;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Plugin;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WP_Admin_Message_Handler;
use SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WP_Job_Batch_Handler;
...
class AutoloadingTest extends TestCase
{
	...
	public function providerCanAutoload() : Generator
	{
		$list = [
			...
			\SkyVerge\WooCommerce\PluginFramework\v5_15_12\Payment_Gateway\REST_API::class,
			REST_API::class,
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v5_15_12\SV_WC_Plugin::setupClassAliases()
	 *
	...
	{
		$aliases = [
			Country_Helper::class            => \SkyVerge\WooCommerce\PluginFramework\v5_15_12\Country_Helper::class,
