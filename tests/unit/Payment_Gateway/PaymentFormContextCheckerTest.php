...
namespace SkyVerge\WooCommerce\PluginFramework\v6_0_1\Tests\Unit\Payment_Gateway;
...
class PaymentFormContextCheckerTest extends TestCase
{
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Payment_Gateway\PaymentFormContextChecker::getContextSessionKeyName()
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Payment_Gateway\PaymentFormContextChecker::maybeSetContext()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Payment_Gateway\PaymentFormContextChecker::getCurrentPaymentFormContext()
	 *
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Payment_Gateway\PaymentFormContextChecker::getStoredPaymentFormContext()
	 * @throws ReflectionException
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_0_1\Payment_Gateway\PaymentFormContextChecker::currentContextRequiresTermsAndConditionsAcceptance()
	 *
