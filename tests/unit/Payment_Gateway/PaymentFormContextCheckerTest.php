...
namespace SkyVerge\WooCommerce\PluginFramework\v6_2_2\Tests\Unit\Payment_Gateway;

use Generator;
use Mockery;
use ReflectionException;
use SkyVerge\WooCommerce\PluginFramework\v6_2_2\Enums\PaymentFormContext;
use SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker;
use SkyVerge\WooCommerce\PluginFramework\v6_2_2\SV_WC_Helper;
...
class PaymentFormContextCheckerTest extends TestCase
{
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker::getContextSessionKeyName()
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker::maybeSetContext()
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker::getCurrentPaymentFormContext()
	 *
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker::getStoredPaymentFormContext()
	 * @throws ReflectionException
	 */
	...
	/**
	 * @covers \SkyVerge\WooCommerce\PluginFramework\v6_2_2\Payment_Gateway\PaymentFormContextChecker::currentContextRequiresTermsAndConditionsAcceptance()
	 *
