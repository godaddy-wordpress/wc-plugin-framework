...
class Plugin extends Test_Case {
	...
	public function test_constructor() {
		...
		$this->assertInstanceOf( '\SkyVerge\WooCommerce\PluginFramework\v5_10_15\SV_WC_Plugin', $this->plugin() );
	}
...
MSG;
	...
	protected function plugin() {
		...
		return $this->getMockBuilder( '\SkyVerge\WooCommerce\PluginFramework\v5_10_15\SV_WC_Plugin' )
