...
if (! class_exists('\\SkyVerge\\WooCommerce\\PluginFramework\\v5_11_9\\SV_WC_Payment_Gateway_Plugin')) :
            ...
            foreach ($this->get_gateways() as $gateway) {
                ...
                if (! wc_checkout_is_https()) {
                    ...
                    if ($gateway->is_production_environment() && $this->get_admin_notice_handler()->should_display_notice('ssl-required')) {
                        ...
                        $message = sprintf(
                            esc_html__('%1$s: WooCommerce is not being forced over SSL; your customers\' payment data may be at risk. %2$sVerify your site URLs here%3$s', 'woocommerce-plugin-framework'),
