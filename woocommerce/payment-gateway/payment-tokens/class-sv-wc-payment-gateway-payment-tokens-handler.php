...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_2\\SV_WC_Payment_Gateway_Payment_Tokens_Handler' ) ) :
...
class SV_WC_Payment_Gateway_Payment_Tokens_Handler {
	 ...
	 * @since 4.3.0
	 *
	 * @return SV_WC_Payment_Gateway The gateway instance
	 */
