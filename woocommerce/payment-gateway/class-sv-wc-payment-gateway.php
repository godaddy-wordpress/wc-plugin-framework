...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_15\\SV_WC_Payment_Gateway' ) ) :
...
abstract class SV_WC_Payment_Gateway extends \WC_Payment_Gateway {
	...
	protected function enqueue_payment_form_assets() {
		...
		$versioned_handle = $handle . '-v5_10_15';
	...
	public function get_card_types() {
		...
		return is_array($this->card_types) ? $this->card_types : array();
	}
