...
use SkyVerge\WooCommerce\PluginFramework\v6_2_0\Helpers\OrderHelper;
...
use SkyVerge\WooCommerce\PluginFramework\v6_2_0\Payment_Gateway\Dynamic_Props;
use stdClass;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_2_0\\SV_WC_Payment_Gateway' ) ) :
...
abstract class SV_WC_Payment_Gateway extends \WC_Payment_Gateway {
	...
	protected function enqueue_payment_form_assets() {
		...
		$versioned_handle = $handle . '-v6_2_0';
