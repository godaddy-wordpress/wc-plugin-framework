...
namespace SkyVerge\WooCommerce\PluginFramework\v5_10_13\Payment_Gateway;
use SkyVerge\WooCommerce\PluginFramework\v5_10_13\REST_API as Plugin_REST_API;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_13\\Payment_Gateway\\REST_API' ) ) :


/**
 * The payment gateway plugin REST API handler class.
 *
 * @see \SkyVerge\WooCommerce\PluginFramework\v5_10_13\REST_API
 *
 * @since 5.2.0
 */
class REST_API extends Plugin_REST_API {
	 ...
	 *
	 * @see \SkyVerge\WooCommerce\PluginFramework\v5_10_13\REST_API::get_system_status_data()
	 *
	 * @since 5.2.0
	 *
	 * @return array
