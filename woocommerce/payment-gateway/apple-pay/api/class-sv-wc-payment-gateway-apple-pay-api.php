...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_7_0\\SV_WC_Payment_Gateway_Apple_Pay_API' ) ) :
...
class SV_WC_Payment_Gateway_Apple_Pay_API extends SV_WC_API_Base {
	...
	public function __construct( SV_WC_Payment_Gateway $gateway ) {
		...
		$this->set_response_handler( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_7_0\\SV_WC_Payment_Gateway_Apple_Pay_API_Response' );
	}
