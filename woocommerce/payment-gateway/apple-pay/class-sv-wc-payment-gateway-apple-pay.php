...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_1\\SV_WC_Payment_Gateway_Apple_Pay' ) ) :
...
class SV_WC_Payment_Gateway_Apple_Pay {
	...
	public function get_supported_networks() {
		...
		$accepted_card_types = array_map( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_2_1\\SV_WC_Payment_Gateway_Helper::normalize_card_type', $accepted_card_types );
