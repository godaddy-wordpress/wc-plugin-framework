...
class SV_WC_Payment_Gateway_Apple_Pay_Frontend extends Handlers\Script_Handler {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'sv-wc-apple-pay-v5_10_0', $this->get_plugin()->get_payment_gateway_framework_assets_url() . '/js/frontend/sv-wc-payment-gateway-apple-pay.min.js', array( 'jquery' ), $this->get_plugin()->get_version(), true );
	}
