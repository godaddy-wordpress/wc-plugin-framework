...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_10\\SV_WC_Payment_Gateway_Apple_Pay_Frontend' ) ) :
 ...
 * @since 4.7.0
 */
class SV_WC_Payment_Gateway_Apple_Pay_Frontend extends \SkyVerge\WooCommerce\PluginFramework\v5_10_10\Payment_Gateway\External_Checkout\Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'sv-wc-apple-pay-v5_10_10', $this->get_plugin()->get_payment_gateway_framework_assets_url() . '/css/frontend/sv-wc-payment-gateway-apple-pay.css', array(), $this->get_plugin()->get_version() ); // TODO: min

		wp_enqueue_script( 'sv-wc-apple-pay-v5_10_10', $this->get_plugin()->get_payment_gateway_framework_assets_url() . '/dist/frontend/sv-wc-payment-gateway-apple-pay.js', array( 'jquery' ), $this->get_plugin()->get_version(), true );
	}
