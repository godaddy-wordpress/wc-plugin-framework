...
use SkyVerge\WooCommerce\PluginFramework\v5_10_2\Payment_Gateway\External_Checkout\Orders;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_2\\SV_WC_Payment_Gateway_Apple_Pay' ) ) :
...
class SV_WC_Payment_Gateway_Apple_Pay extends Payment_Gateway\External_Checkout\External_Checkout {
	...
	public function get_supported_networks() {
		...
		$accepted_card_types = array_map( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_2\\SV_WC_Payment_Gateway_Helper::normalize_card_type', $accepted_card_types );
