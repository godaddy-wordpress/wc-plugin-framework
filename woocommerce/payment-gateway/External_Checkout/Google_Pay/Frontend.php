...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_14\\Payment_Gateway\\External_Checkout\\Google_Pay\\Frontend' ) ) :
 ...
 * @since 5.10.0
 */
class Frontend extends \SkyVerge\WooCommerce\PluginFramework\v5_10_14\Payment_Gateway\External_Checkout\Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'sv-wc-google-pay-v5_10_14', $this->get_plugin()->get_payment_gateway_framework_assets_url() . '/dist/frontend/sv-wc-payment-gateway-google-pay.js', [ 'google-pay-js-library', 'jquery' ], $this->get_plugin()->get_version(), true );
	}
