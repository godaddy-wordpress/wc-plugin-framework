...
use SkyVerge\WooCommerce\PluginFramework\v5_12_7\Handlers\Script_Handler;
use SkyVerge\WooCommerce\PluginFramework\v5_12_7\SV_WC_Helper;
...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_12_7\\Payment_Gateway\\External_Checkout\\Frontend' ) ) :
...
abstract class Frontend extends Script_Handler {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'sv-wc-external-checkout-v5_12_7', $this->get_handler()->get_plugin()->get_payment_gateway_framework_assets_url() . '/css/frontend/sv-wc-payment-gateway-external-checkout.css', array(), $this->get_handler()->get_plugin()->get_version() ); // TODO: min
	}
