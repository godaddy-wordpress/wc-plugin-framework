...
namespace SkyVerge\WooCommerce\PluginFramework\v6_1_1\Payment_Gateway\External_Checkout;

use SkyVerge\WooCommerce\PluginFramework\v6_1_1\Blocks\Blocks_Handler;
use SkyVerge\WooCommerce\PluginFramework\v6_1_1\Handlers\Script_Handler;
...
use SkyVerge\WooCommerce\PluginFramework\v6_1_1\SV_WC_Payment_Gateway;
use SkyVerge\WooCommerce\PluginFramework\v6_1_1\SV_WC_Payment_Gateway_Plugin;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_1_1\\Payment_Gateway\\External_Checkout\\Frontend' ) ) :
...
abstract class Frontend extends Script_Handler {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'sv-wc-external-checkout-v6_1_1', $this->get_handler()->get_plugin()->get_payment_gateway_framework_assets_url() . '/css/frontend/sv-wc-payment-gateway-external-checkout.css', array(), $this->get_handler()->get_plugin()->get_version() ); // TODO: min
	}
