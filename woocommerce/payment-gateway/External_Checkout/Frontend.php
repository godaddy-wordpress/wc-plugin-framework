...
use SkyVerge\WooCommerce\PluginFramework\v5_10_11\Handlers\Script_Handler;
...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_10_11\\Payment_Gateway\\External_Checkout\\Frontend' ) ) :
...
abstract class Frontend extends Script_Handler {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'sv-wc-external-checkout-v5_10_11', $this->get_handler()->get_plugin()->get_payment_gateway_framework_assets_url() . '/css/frontend/sv-wc-payment-gateway-external-checkout.css', array(), $this->get_handler()->get_plugin()->get_version() ); // TODO: min
	}
