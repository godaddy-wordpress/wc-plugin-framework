...
(function() {
  jQuery(document).ready(function($) {
    "use strict";
    var accounting, addCaptureEvents, observer, ref, ref1, ref2, ref3, submitCapture, sv_wc_payment_gateway_admin_order, woocommerce_admin, woocommerce_admin_meta_boxes;
    ...
    observer = new MutationObserver(function(e) {
      return addCaptureEvents();
    });
    observer.observe($('#woocommerce-order-items')[0], {
      childList: true
    });
    addCaptureEvents = function() {
