...
jQuery(document).ready(function ($) {
  ...
  window.SV_WC_Google_Pay_Handler_v5_8_1 = /*#__PURE__*/function () {
    ...
    _createClass(SV_WC_Google_Pay_Handler_v5_8_1, [{
          ...
          try {
            ...
            if (intermediatePaymentData.callbackTrigger == "INITIALIZE" || intermediatePaymentData.callbackTrigger == "SHIPPING_ADDRESS") {
              if (shippingAddress.administrativeArea == "NJ") {
                ...
                _this4.calculateNewTransactionInfo(selectedShippingOptionId, function (newTransactionInfo) {
              ...
              paymentDataRequestUpdate.newTransactionInfo = _this4.calculateNewTransactionInfo(shippingOptionData.id, function (newTransactionInfo) {
                paymentDataRequestUpdate.newTransactionInfo = newTransactionInfo;
                console.log('paymentDataRequestUpdate');
                console.log(paymentDataRequestUpdate);
                resolve(paymentDataRequestUpdate);
      ...
      value: function calculateNewTransactionInfo(shippingOptionId, resolve) {
        var _this5 = this;
