...
jQuery(document).ready(function ($) {
  ...
  window.SV_WC_Google_Pay_Handler_v5_8_1 = /*#__PURE__*/function () {
    ...
    _createClass(SV_WC_Google_Pay_Handler_v5_8_1, [{
          ...
          try {
            ...
            if (intermediatePaymentData.callbackTrigger == "INITIALIZE" || intermediatePaymentData.callbackTrigger == "SHIPPING_ADDRESS") {
              if (shippingAddress.administrativeArea == "NJ") {
                paymentDataRequestUpdate.error = _this4.getGoogleUnserviceableAddressError();
              } else {
                paymentDataRequestUpdate.newShippingOptionParameters = _this4.getGoogleDefaultShippingOptions();
                var selectedShippingOptionId = paymentDataRequestUpdate.newShippingOptionParameters.defaultSelectedOptionId;
                paymentDataRequestUpdate.newTransactionInfo = _this4.calculateNewTransactionInfo(selectedShippingOptionId);
              }
            } else if (intermediatePaymentData.callbackTrigger == "SHIPPING_OPTION") {
              paymentDataRequestUpdate.newTransactionInfo = _this4.calculateNewTransactionInfo(shippingOptionData.id);
            }
      ...
      key: "calculateNewTransactionInfo",
      value: function calculateNewTransactionInfo(shippingOptionId) {
        var _this5 = this;

        this.getGoogleTransactionInfo(function (newTransactionInfo) {
          var shippingCost = _this5.getShippingCosts()[shippingOptionId];
          ...
          var totalPrice = 0.00;
          newTransactionInfo.displayItems.forEach(function (displayItem) {
            return totalPrice += parseFloat(displayItem.price);
          });
      ...
      value: function getGoogleTransactionInfo(resolve) {
        ...
        $.post(this.ajaxURL, data, function (response) {
          ...
          if (response.success) {
            ...
            _this6.fail_payment('Could not build transaction info. ' + response.data.message);
          }
        });
      }
      /**
      ...
      key: "getShippingCosts",
      value: function getShippingCosts() {
      ...
      key: "getGoogleDefaultShippingOptions",
      value: function getGoogleDefaultShippingOptions() {
        return {
      ...
      value: function prefetchGooglePaymentData() {
        ...
        this.getGooglePaymentDataRequest().then(function (paymentDataRequest) {
