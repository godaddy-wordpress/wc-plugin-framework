...
jQuery(document).ready(function ($) {
  ...
  window.SV_WC_Google_Pay_Handler_v5_10_0 = /*#__PURE__*/function () {
    /**
     * Handler constructor.
     *
     * @since 5.10.0
     ...
     */
    function SV_WC_Google_Pay_Handler_v5_10_0(params) {
      _classCallCheck(this, SV_WC_Google_Pay_Handler_v5_10_0);
      ...
      var plugin_id = params.plugin_id,
          ...
          available_countries = params.available_countries,
    ...
    _createClass(SV_WC_Google_Pay_Handler_v5_10_0, [{
      ...
      value: function onPaymentAuthorized(paymentData) {
        ...
        return new Promise(function (resolve, reject) {
          // handle the response
          try {
            _this3.processPayment(paymentData, resolve);
          } catch (err) {
            reject({
      ...
      value: function onPaymentDataChanged(intermediatePaymentData) {
        ...
        return new Promise(function (resolve, reject) {
          try {
            ...
            _this4.fail_payment('Could not load updated totals or process payment data request update. ' + err);
          }
      ...
      value: function addGooglePayButton() {
        ...
        var button = paymentsClient.createButton({
          onClick: function onClick(event) {
            return _this7.onGooglePaymentButtonClicked(event);
          },
      ...
      value: function prefetchGooglePaymentData() {
        ...
        this.getGooglePaymentDataRequest(function (paymentDataRequest) {
          ...
          paymentDataRequest.transactionInfo = {
            ...
            currencyCode: _this8.currencyCode
          };
      ...
      value: function processPayment(paymentData, resolve) {
        ...
        return $.post(this.ajaxURL, data, function (response) {
          if (response.success) {
            ...
            _this9.fail_payment('Payment could not be processed. ' + response.data.message);
          }
        });
      }
      /**
      ...
      value: function onGooglePaymentButtonClicked(event) {
        ...
        this.getGooglePaymentDataRequest(function (paymentDataRequest) {
          ...
          try {
            ...
            _this10.fail_payment('Could not load payment data. ' + err);
          }
      ...
      value: function init() {
        ...
        paymentsClient.isReadyToPay(this.getGoogleIsReadyToPayRequest()).then(function (response) {
          if (response.result) {
            _this11.addGooglePayButton(); // prefetch payment data to improve performance


            _this11.prefetchGooglePaymentData();
          }
        })["catch"](function (err) {
          _this11.fail_payment('Google Pay is not ready. ' + err);
        });
      }
      /**
    ...
    return SV_WC_Google_Pay_Handler_v5_10_0;
  }();
