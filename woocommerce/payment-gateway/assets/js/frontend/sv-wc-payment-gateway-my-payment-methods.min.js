  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Methods_Handler = (function() {
      function SV_WC_Payment_Methods_Handler(args) {
        ...
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".woocommerce-PaymentMethod--actions .edit-payment-method", (function(_this) {
          return function(event) {
            return _this.edit_method(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".woocommerce-PaymentMethod--actions .save-payment-method", (function(_this) {
          return function(event) {
            return _this.save_method(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".woocommerce-PaymentMethod--actions .cancel-edit-payment-method", (function(_this) {
          return function(event) {
            return _this.cancel_edit(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".woocommerce-PaymentMethod--actions .delete-payment-method", (function(_this) {
          return function(event) {
