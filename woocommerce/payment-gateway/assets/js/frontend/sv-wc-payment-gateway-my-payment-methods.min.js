...
(function() {
  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Methods_Handler = (function() {
      ...
      SV_WC_Payment_Methods_Handler.prototype.replace_method_column = function() {
        return $('.woocommerce-MyAccount-paymentMethods').find('tr').each((function(_this) {
          return function(index, element) {
            ...
            if (titleColumn.children().length > 0) {
              return $(element).find('td.woocommerce-PaymentMethod--method').replaceWith(titleColumn);
            } else {
