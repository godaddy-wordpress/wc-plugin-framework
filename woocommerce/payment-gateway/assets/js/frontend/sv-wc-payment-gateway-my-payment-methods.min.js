...
(function() {
  ...
  jQuery(document).ready(function($) {
    "use strict";
    window.SV_WC_Payment_Methods_Handler_v5_9_0 = (function() {
      function SV_WC_Payment_Methods_Handler_v5_9_0(args) {
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.replace_method_column = function() {
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.remove_duplicate_default_marks = function() {
        return $('.woocommerce-MyAccount-paymentMethods').find('tr').each((function(_this) {
          return function(index, element) {
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.edit_method = function(event) {
        var button, row;
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.save_method = function(event) {
        var button, data, row;
        event.preventDefault();
        button = $(event.currentTarget);
        row = button.parents('tr');
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.cancel_edit = function(event) {
        var button, row;
        event.preventDefault();
        button = $(event.currentTarget);
        row = button.parents('tr');
      ...
      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.unblock_ui = function() {
        return $(".woocommerce-MyAccount-paymentMethods").parent('div').unblock();
      };

      SV_WC_Payment_Methods_Handler_v5_9_0.prototype.display_error = function(row, error, message) {
        var columns;
        if (message == null) {
          message = '';
        }
      ...
      return SV_WC_Payment_Methods_Handler_v5_9_0;

    })();
    return $(document.body).trigger('sv_wc_payment_methods_handler_v5_9_0_loaded');
  });
