  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Methods_Handler = (function() {
      function SV_WC_Payment_Methods_Handler(args) {
        ...
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".wc-" + this.slug + "-payment-method-actions .edit-payment-method", (function(_this) {
          return function(event) {
            return _this.edit_method(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".wc-" + this.slug + "-payment-method-actions .save-payment-method", (function(_this) {
          return function(event) {
            return _this.save_method(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".wc-" + this.slug + "-payment-method-actions .cancel-edit-payment-method", (function(_this) {
          return function(event) {
            return _this.cancel_edit(event);
          };
        })(this));
        $(".woocommerce-MyAccount-paymentMethods").on('click', ".wc-" + this.slug + "-payment-method-actions .delete-payment-method", (function(_this) {
          return function(event) {
