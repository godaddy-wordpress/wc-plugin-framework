  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Methods_Handler = (function() {
      ...
      SV_WC_Payment_Methods_Handler.prototype.edit_method = function(event) {
        ...
        button.text(this.i18n.cancel_button).removeClass('edit').addClass('cancel-edit-payment-method').removeClass('button');
      ...
      SV_WC_Payment_Methods_Handler.prototype.cancel_edit = function(event) {
        ...
        button.removeClass('cancel-edit-payment-method').addClass('edit').text(this.i18n.edit_button).addClass('button');
