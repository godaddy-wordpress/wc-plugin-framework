...
(function() {
  ...
  jQuery(document).ready(function($) {
    "use strict";
    window.SV_WC_Payment_Form_Handler_v5_7_0 = (function() {
      function SV_WC_Payment_Form_Handler_v5_7_0(args) {
        this.id = args.id;
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.handle_checkout_page = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.handle_pay_page = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.handle_add_payment_method_page = function() {
        this.set_payment_fields();
        if (this.type === 'credit-card') {
          this.format_credit_card_inputs();
        }
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.set_payment_fields = function() {
        var $required_fields;
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.validate_payment_data = function() {
        var handler, valid;
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.format_credit_card_inputs = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.do_inline_credit_card_validation = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.validate_card_data = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.validate_account_data = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.render_errors = function(errors) {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.handle_saved_payment_methods = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.handle_sample_check_hint = function() {
        var $sample_check;
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.block_ui = function() {
      ...
      SV_WC_Payment_Form_Handler_v5_7_0.prototype.unblock_ui = function() {
        return this.form.unblock();
      };

      return SV_WC_Payment_Form_Handler_v5_7_0;

    })();
    return $(document.body).trigger("sv_wc_payment_form_handler_v5_7_0_loaded");
  });
