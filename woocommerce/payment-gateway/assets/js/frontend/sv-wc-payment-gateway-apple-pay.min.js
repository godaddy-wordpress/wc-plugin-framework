...
(function() {
  ...
  jQuery(document).ready(function($) {
    "use strict";
    return window.SV_WC_Apple_Pay_Handler = (function() {
      ...
      SV_WC_Apple_Pay_Handler.prototype.init_product_page = function() {
        return this.ui_element = $('form.cart');
      };

      SV_WC_Apple_Pay_Handler.prototype.init_cart_page = function() {
      ...
      SV_WC_Apple_Pay_Handler.prototype.init_checkout_page = function() {
      ...
      SV_WC_Apple_Pay_Handler.prototype.get_new_session = function(payment_request) {
        return new ApplePaySession(this.get_sdk_version(), payment_request);
      };

      SV_WC_Apple_Pay_Handler.prototype.get_sdk_version = function() {
        return 2;
      };
      ...
      SV_WC_Apple_Pay_Handler.prototype.set_payment_status = function(success) {
        var status;
        if (success) {
