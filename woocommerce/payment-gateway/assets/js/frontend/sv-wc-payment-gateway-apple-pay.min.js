...
(function() {
  ...
  jQuery(document).ready(function($) {
    "use strict";
    window.SV_WC_Apple_Pay_Handler_v5_9_0 = (function() {
      function SV_WC_Apple_Pay_Handler_v5_9_0(args) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.is_available = function() {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.init = function() {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.init_product_page = function() {
        return this.ui_element = $('form.cart');
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.init_cart_page = function() {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.init_checkout_page = function() {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.get_new_session = function(payment_request) {
        return new ApplePaySession(this.get_sdk_version(), payment_request);
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.get_sdk_version = function() {
        return 2;
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_validate_merchant = function(event) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.validate_merchant = function(url) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_payment_method_selected = function(event) {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            var data;
            data = {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_shipping_contact_selected = function(event) {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            var data;
            data = {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_shipping_method_selected = function(event) {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            var data;
            data = {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_payment_authorized = function(event) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.process_authorization = function(payment) {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            var data;
            data = {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.on_cancel_payment = function(event) {
        return this.unblock_ui();
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.complete_purchase = function(response) {
        return window.location = response.redirect;
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.fail_payment = function(error) {
        console.error('[Apple Pay] ' + error);
        this.unblock_ui();
        return this.render_errors([this.generic_error]);
      };

      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.set_payment_status = function(success) {
        var status;
        if (success) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.reset_payment_request = function(data) {
        if (data == null) {
          data = {};
        }
        this.block_ui();
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.get_payment_request = function(data) {
        return new Promise((function(_this) {
          return function(resolve, reject) {
            var base_data;
            base_data = {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.render_errors = function(errors) {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.block_ui = function() {
      ...
      SV_WC_Apple_Pay_Handler_v5_9_0.prototype.unblock_ui = function() {
        return this.ui_element.unblock();
      };

      return SV_WC_Apple_Pay_Handler_v5_9_0;

    })();
    return $(document.body).trigger('sv_wc_apple_pay_handler_v5_9_0_loaded');
  });
