  ...
  jQuery(document).ready(function($) {
    ...
    window.SV_WC_Apple_Pay_Handler = (function() {
      ...
      SV_WC_Apple_Pay_Handler.prototype.fail_payment = function(error) {
        ...
        this.unblock_ui();
        return this.render_errors(['An error occurred']);
      };
    ...
    return window.SV_WC_Apple_Pay_Product_Handler = (function(superClass) {
      ...
      function SV_WC_Apple_Pay_Product_Handler(args) {
        ...
        this.init_variations = bind(this.init_variations, this);
        this.payment_form = $('form.cart');
        this.product_id = args.product_id;
        SV_WC_Apple_Pay_Product_Handler.__super__.constructor.call(this, args);
        $(document.body).on('show_variation', (function(_this) {
          return function(event, variation, purchasable) {
            return _this.init_variations(variation.variation_id, purchasable);
          };
        })(this));
      }

      SV_WC_Apple_Pay_Product_Handler.prototype.init_variations = function(variation_id, purchasable) {
        if (variation_id && purchasable) {
      ...
      SV_WC_Apple_Pay_Product_Handler.prototype.init = function() {
        if (this.product_id === 0) {
          return;
        }
        return SV_WC_Apple_Pay_Product_Handler.__super__.init.call(this);
      };
