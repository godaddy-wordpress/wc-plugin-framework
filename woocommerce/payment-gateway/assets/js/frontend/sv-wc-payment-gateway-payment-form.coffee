...
jQuery ( $ ) ->
	...
	class window.SV_WC_Payment_Form_Handler_v999_9_9
		...
		#
		# Returns SV_WC_Payment_Form_Handler_v999_9_9 instance
		constructor: (args) ->
	...
	$( document.body ).trigger( "sv_wc_payment_form_handler_v999_9_9_loaded" )
