...
jQuery ( $ ) ->
	...
	class window.SV_WC_Payment_Form_Handler_v5_10_16
		...
		#
		# Returns SV_WC_Payment_Form_Handler_v5_10_16 instance
		constructor: (args) ->
	...
	$( document.body ).trigger( "sv_wc_payment_form_handler_v5_10_16_loaded" )
