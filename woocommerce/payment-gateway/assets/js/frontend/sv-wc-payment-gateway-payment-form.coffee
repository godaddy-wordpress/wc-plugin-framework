...
jQuery ( $ ) ->
	...
	class window.SV_WC_Payment_Form_Handler_v6_0_2
		...
		#
		# Returns SV_WC_Payment_Form_Handler_v6_0_2 instance
		constructor: (args) ->
	...
	$( document.body ).trigger( "sv_wc_payment_form_handler_v6_0_2_loaded" )
