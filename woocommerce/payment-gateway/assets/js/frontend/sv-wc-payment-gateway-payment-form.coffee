...
jQuery ( $ ) ->
	...
	class window.SV_WC_Payment_Form_Handler_v6_2_3
		...
		#
		# Returns SV_WC_Payment_Form_Handler_v6_2_3 instance
		constructor: (args) ->
	...
	$( document.body ).trigger( "sv_wc_payment_form_handler_v6_2_3_loaded" )
