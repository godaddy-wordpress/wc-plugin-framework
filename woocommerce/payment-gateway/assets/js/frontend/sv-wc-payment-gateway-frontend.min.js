  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Form_Handler = (function() {
      ...
      SV_WC_Payment_Form_Handler.prototype.validate_payment_data = function() {
        ...
        tokenized_payment_method_selected = this.payment_fields.find('.js-wc-payment-gateway-payment-token:checked').val();
...
//# sourceMappingURL=sv-wc-payment-gateway-frontend.min.js.map
