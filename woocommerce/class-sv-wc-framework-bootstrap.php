	...
	public function render_update_notices() {
		...
		if ( ! empty( $this->incompatible_framework_plugins ) ) {
			...
			echo '<div class="error">';
				...
				echo '<p>';
					printf(
						/* translators: Context is for plugins to activate or deactivate tags. HTML Placeholders: %1$s - <a> tag, %2$s - </a> tag, %3$s - <em> tag, %4$s - </em> tag, %5$s - <a> tag, %6$s - </a> tag, %7$s - <a> tag, %8$s - </a> tag */
