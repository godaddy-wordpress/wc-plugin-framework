...
namespace SkyVerge\WooCommerce\PluginFramework\v5_15_9\Handlers;
...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_15_9\\Handlers\\Script_Handler' ) ) :
...
abstract class Script_Handler {
	...
	protected function get_js_handler_class_name() {
		...
		return sprintf( '%s_v5_15_9', $this->js_handler_base_class_name );
	}
