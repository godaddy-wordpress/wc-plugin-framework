...
if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_1_4\\SV_WC_Plugin_Compatibility' ) ) :
...
class SV_WC_Plugin_Compatibility {
	...
	public static function wc_format_datetime( $date, $format = '' ) {
		...
		if ( self::is_wc_version_gte_3_0() ) {
			...
			if ( ! is_a( $date, '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_1_4\\SV_WC_DateTime' ) ) { // TODO: verify this {CW 2017-07-18}
				return '';
			}
