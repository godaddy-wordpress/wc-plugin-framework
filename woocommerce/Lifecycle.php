...
namespace SkyVerge\WooCommerce\PluginFramework\v5_7_0\Plugin;

use SkyVerge\WooCommerce\PluginFramework\v5_7_0\Admin\Notes_Helper;
use SkyVerge\WooCommerce\PluginFramework\v5_7_0\SV_WC_Payment_Gateway_Plugin;
use SkyVerge\WooCommerce\PluginFramework\v5_7_0\SV_WC_Plugin;
use SkyVerge\WooCommerce\PluginFramework\v5_7_0\SV_WC_Plugin_Compatibility;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_7_0\\Plugin\\Lifecycle' ) ) :
