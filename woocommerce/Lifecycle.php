...
namespace SkyVerge\WooCommerce\PluginFramework\v5_5_3\Plugin;

use SkyVerge\WooCommerce\PluginFramework\v5_5_3\SV_WC_Plugin;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_5_3\\Plugin\\Lifecycle' ) ) :
