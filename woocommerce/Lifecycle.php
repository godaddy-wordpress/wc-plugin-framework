...
namespace SkyVerge\WooCommerce\PluginFramework\v5_1_1\Plugin;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_1_1\\Plugin\\Lifecycle' ) ) :
...
class Lifecycle {
	...
	/** @var \SkyVerge\WooCommerce\PluginFramework\v5_1_1\SV_WC_Plugin plugin instance */
	private $plugin;
	 ...
	 * @since 5.1.0
	 *
	 * @param \SkyVerge\WooCommerce\PluginFramework\v5_1_1\SV_WC_Plugin $plugin plugin instance
	 */
	public function __construct( \SkyVerge\WooCommerce\PluginFramework\v5_1_1\SV_WC_Plugin $plugin ) {
	 ...
	 * @since 5.1.0
	 *
	 * @return \SkyVerge\WooCommerce\PluginFramework\v5_1_1\SV_WC_Plugin
	 */
