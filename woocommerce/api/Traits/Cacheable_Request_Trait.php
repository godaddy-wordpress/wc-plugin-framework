...
namespace SkyVerge\WooCommerce\PluginFramework\v6_0_1\API\Traits;

defined( 'ABSPATH' ) or exit;

if ( ! trait_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_0_1\\API\\Traits\\Cacheable_Request_Trait' ) ) :
