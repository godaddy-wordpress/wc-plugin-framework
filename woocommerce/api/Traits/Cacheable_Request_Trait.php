...
namespace SkyVerge\WooCommerce\PluginFramework\v6_1_2\API\Traits;

defined( 'ABSPATH' ) or exit;

if ( ! trait_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_1_2\\API\\Traits\\Cacheable_Request_Trait' ) ) :
