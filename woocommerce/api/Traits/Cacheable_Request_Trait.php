...
namespace SkyVerge\WooCommerce\PluginFramework\v6_2_3\API\Traits;

defined( 'ABSPATH' ) or exit;

if ( ! trait_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_2_3\\API\\Traits\\Cacheable_Request_Trait' ) ) :
