...
namespace SkyVerge\WooCommerce\PluginFramework\v5_12_6\API;

use SkyVerge\WooCommerce\PluginFramework\v5_12_6\SV_WC_API_Base;
use SkyVerge\WooCommerce\PluginFramework\v5_12_6\API\Traits\Cacheable_Request_Trait;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_12_6\\API\\Abstract_Cacheable_API_Base' ) ) :
