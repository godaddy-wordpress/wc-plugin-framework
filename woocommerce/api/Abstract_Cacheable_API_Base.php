...
namespace SkyVerge\WooCommerce\PluginFramework\v5_15_1\API;

use SkyVerge\WooCommerce\PluginFramework\v5_15_1\SV_WC_API_Base;
use SkyVerge\WooCommerce\PluginFramework\v5_15_1\API\Traits\Cacheable_Request_Trait;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v5_15_1\\API\\Abstract_Cacheable_API_Base' ) ) :
