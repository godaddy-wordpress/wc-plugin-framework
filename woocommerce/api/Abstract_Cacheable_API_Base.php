...
namespace SkyVerge\WooCommerce\PluginFramework\v6_1_5\API;

use SkyVerge\WooCommerce\PluginFramework\v6_1_5\SV_WC_API_Base;
use SkyVerge\WooCommerce\PluginFramework\v6_1_5\API\Traits\Cacheable_Request_Trait;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_1_5\\API\\Abstract_Cacheable_API_Base' ) ) :
