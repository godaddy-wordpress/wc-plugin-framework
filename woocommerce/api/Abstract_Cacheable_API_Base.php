...
namespace SkyVerge\WooCommerce\PluginFramework\v6_2_2\API;

use SkyVerge\WooCommerce\PluginFramework\v6_2_2\SV_WC_API_Base;
use SkyVerge\WooCommerce\PluginFramework\v6_2_2\API\Traits\Cacheable_Request_Trait;

defined( 'ABSPATH' ) or exit;

if ( ! class_exists( '\\SkyVerge\\WooCommerce\\PluginFramework\\v6_2_2\\API\\Abstract_Cacheable_API_Base' ) ) :
